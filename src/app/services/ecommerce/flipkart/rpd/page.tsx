...
export default function ServicePage() {
  return (
    <SubServiceLayout 
      title="Flipkart RPD" 
      subtitle="Dedicated expert solutions for Flipkart RPD."
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img 
        src="/images/services/ecommerce/flipkart-rpd.jpg" 
        alt="Flipkart RPD" 
        className="featured-image" 
      />
      
      <h2>Flipkart RPD Expertise</h2>
      <p>
        Our dedicated team specializes in comprehensive <strong>Flipkart RPD</strong> to ensure maximum visibility, optimized conversion rates, and sustainable growth for your brand on the marketplace.
      </p>
