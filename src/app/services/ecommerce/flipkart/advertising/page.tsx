...
export default function ServicePage() {
  return (
    <SubServiceLayout 
      ...
      subtitle="Dedicated expert solutions for Flipkart Advertising."
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img 
        src="/images/services/ecommerce/flipkart-advertising.jpg" 
        alt="Flipkart Advertising" 
        className="featured-image" 
      />
      
      <h2>Flipkart Advertising Expertise</h2>
      <p>
        Our dedicated team specializes in comprehensive <strong>Flipkart Advertising</strong> to ensure maximum visibility, optimized conversion rates, and sustainable growth for your brand on the marketplace.
      </p>
