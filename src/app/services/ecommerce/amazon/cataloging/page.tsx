...
export default function ServicePage() {
  return (
    <SubServiceLayout 
      ...
      subtitle="Dedicated expert solutions for Amazon Cataloging."
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img 
        src="/images/services/ecommerce/amazon-cataloging.jpg" 
        alt="Amazon Cataloging" 
        className="featured-image" 
      />
      
      <h2>Amazon Cataloging Expertise</h2>
      <p>
        Our dedicated team specializes in comprehensive <strong>Amazon Cataloging</strong> to ensure maximum visibility, optimized conversion rates, and sustainable growth for your brand on the marketplace.
      </p>
