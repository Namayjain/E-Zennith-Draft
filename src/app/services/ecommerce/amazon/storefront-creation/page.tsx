...
export default function ServicePage() {
  return (
    <SubServiceLayout 
      title="Amazon Storefront Creation" 
      subtitle="Dedicated expert solutions for Amazon Storefront Creation."
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img 
        src="/images/services/ecommerce/amazon-storefront-creation.jpg" 
        alt="Amazon Storefront Creation" 
        className="featured-image" 
      />
      
      <h2>Amazon Storefront Creation Expertise</h2>
      <p>
        Our dedicated team specializes in comprehensive <strong>Amazon Storefront Creation</strong> to ensure maximum visibility, optimized conversion rates, and sustainable growth for your brand on the marketplace.
      </p>
