...
export default function ServicePage() {
  return (
    <SubServiceLayout 
      title="Amazon Brand Videos" 
      subtitle="Dedicated expert solutions for Amazon Brand Videos."
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img 
        src="/images/services/ecommerce/amazon-brand-videos.jpg" 
        alt="Amazon Brand Videos" 
        className="featured-image" 
      />
      
      <h2>Amazon Brand Videos Expertise</h2>
      <p>
        Our dedicated team specializes in comprehensive <strong>Amazon Brand Videos</strong> to ensure maximum visibility, optimized conversion rates, and sustainable growth for your brand on the marketplace.
      </p>
